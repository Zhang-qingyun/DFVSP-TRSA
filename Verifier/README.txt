...
Afterward, there is an executable "verifier". The verifier expects
as the first argument a path to graph file in the following format:
...
The verifier checks whether the subgraph induced by removing all nodes in the feedback vertex set is acyclic. 
The verifier does not check for optimality.
